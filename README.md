...
This kata was created as an exercise for the Pillar application process. It simulates the use of a graphite pencil and includes functionality for writing and editing text, point degradation, using the eraser, and sharpening the pencil. 
